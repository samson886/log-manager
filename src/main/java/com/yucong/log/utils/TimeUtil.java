...
public class TimeUtil {
	...
	public static Date getTimeFromString(String timeStr, String format) {
		try {
			return StringUtils.isBlank(timeStr) ? null : new SimpleDateFormat(format).parse(timeStr);
...
//		// long timestamp = 1469526700000L;
//		long timestamp = 1467290747000L;
//		// System.out.println(getFormatTimeFromTimestamp(timestamp,
//		// TIME_FORMAT_SHOW_MILLISECOND_WITH_COLON));
//		System.out.println(getTimeFromString("2017-11-02", FORMAT_DATE_TIME));
	}
}
